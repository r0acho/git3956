...
## Информация для домашнего задания

> ## Работа с удаленным репозиторием (Домашнее задание)

1. Делаем форк репозитория
2. Клонируем "форкнутый" репозиторий
3. Создаем новую ветку с предложенными изменениями 
4. Производим все изменения в этой ветке
5. Отправляем на свой репозиторий (форк)
6. В окне Github появляется запрос "Compare and pull-request"
